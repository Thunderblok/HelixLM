"""
Medium-scale CCA training: 50K samples, 512 seq, 3 epochs.
Architecture: A3 lock (d=384, n_loops=1, 2 columns of 2 nodes).
With attention_mask fix + Curriculum Component Activation.
"""
import sys, os, math, random, json, time
sys.path.insert(0, "/app/HelixLM")
...
def main():
    ...
    # Push to hub
    hub_id = os.environ.get("HUB_MODEL_ID", "")
    if hub_id:
